...
function Home() {
  ...
  return (
    <>
      ...
      <Hero>
        <HeroInner>
          <HeroText>
            ...
            <p>
              Найдите идеальную баню или сауну: спросите ИИ-помощника на естественном языке или
              выберите на карте. Каталог проверенных заведений с 2012 года.
            </p>
            <Stats>
              <div>
                <strong>1 200+</strong>
          ...
          <AIChatPanel messages={messages} onSend={handleSend} suggestions={SUGGESTIONS} />
        </HeroInner>
      </Hero>
      ...
      <AIChatFloating messages={messages} onSend={handleSend} suggestions={SUGGESTIONS} />
    </>
  );
}
