        ...
        <Aside>
          <Benefits>
            ...
            <ul>
              ...
              <li>
                <Check size={18} /> Отзывы от реальных посетителей
              </li>
              <li>
                <Check size={18} /> Размещение на интерактивной карте
              </li>
              <li>
                <Check size={18} /> Рекомендации в ИИ-помощнике
              </li>
              <li>
                <Check size={18} /> Аналитика просмотров и обращений
              </li>
            </ul>
          </Benefits>
        </Aside>
